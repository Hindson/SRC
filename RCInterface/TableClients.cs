    ...
    public partial class TableClients : UserControl
    {
        ...
        private void tSButton_Remove_Click(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow == null)
                MessageBox.Show("Клиенты отсутствуют в таблице!", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            else
        ...
        private void dataGridView1_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            try
            {
                ...
                {
                    Client.Clients[dataGridView1.CurrentRow.Index].DateDriverLicense = Convert.ToDateTime(e.FormattedValue);
                }
