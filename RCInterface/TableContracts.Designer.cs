namespace RCInterface
{
    partial class TableContracts
    {
        ...
        private void InitializeComponent()
        {
            ...
            idDataGridViewTextBoxColumn.HeaderText = "Номер договора";
            idDataGridViewTextBoxColumn.Name = "idDataGridViewTextBoxColumn";
            idDataGridViewTextBoxColumn.ReadOnly = true;
            // 
            // renterDataGridViewTextBoxColumn
            // 
            renterDataGridViewTextBoxColumn.AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            renterDataGridViewTextBoxColumn.DataPropertyName = "Renter";
            renterDataGridViewTextBoxColumn.HeaderText = "Арендатор";
            renterDataGridViewTextBoxColumn.Name = "renterDataGridViewTextBoxColumn";
            renterDataGridViewTextBoxColumn.ReadOnly = true;
            renterDataGridViewTextBoxColumn.Width = 91;
            // 
            // carDataGridViewTextBoxColumn
            // 
            carDataGridViewTextBoxColumn.AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            carDataGridViewTextBoxColumn.DataPropertyName = "Car";
            carDataGridViewTextBoxColumn.HeaderText = "Автомобиль";
            carDataGridViewTextBoxColumn.Name = "carDataGridViewTextBoxColumn";
            carDataGridViewTextBoxColumn.ReadOnly = true;
            carDataGridViewTextBoxColumn.Width = 101;
            // 
            // employeeDataGridViewTextBoxColumn
            // 
            employeeDataGridViewTextBoxColumn.AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            employeeDataGridViewTextBoxColumn.DataPropertyName = "Employee";
            employeeDataGridViewTextBoxColumn.HeaderText = "Работник";
            employeeDataGridViewTextBoxColumn.Name = "employeeDataGridViewTextBoxColumn";
            employeeDataGridViewTextBoxColumn.ReadOnly = true;
            employeeDataGridViewTextBoxColumn.Width = 84;
            // 
            // startDateDataGridViewTextBoxColumn
            // 
            startDateDataGridViewTextBoxColumn.DataPropertyName = "StartDate";
            startDateDataGridViewTextBoxColumn.HeaderText = "Дата начала аренды";
            ...
            endDateDataGridViewTextBoxColumn.HeaderText = "Дата окончания аренды";
            ...
            rentalPriceDataGridViewTextBoxColumn.HeaderText = "Цена аренды (грн)";
            ...
            // 
            contractBindingSource.DataSource = typeof(RCLibrary.Contract);
            // 
            // tSButton_Update
            // 
            ...
            tSButton_Remove.ToolTipText = "Удалить договор";
            ...
            tSButton_Add.ToolTipText = "Добавить новый договор";
